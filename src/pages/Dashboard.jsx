								...
								<div className='d-flex align-items-start justify-content-between'>
									...
									<div className='d-flex align-items-center justify-content-between'>
										<span className='avatar avatar-md rounded-circle bg-soft-primary border border-primary'>
											<IconFileAnalytics size={16} className='text-primary' />
										</span>
									</div>
								</div>
							</div>
								...
								<div className='d-flex align-items-start justify-content-between'>
									...
									<div className='d-flex align-items-center justify-content-between'>
										<span className='avatar avatar-md rounded-circle bg-soft-warning border border-warning'>
											<IconActivity size={16} className='text-warning' />
										</span>
									</div>
								</div>
							</div>
							...
							<div className='card-body'>
								<Chart
									options={{
										...
										plotOptions: {
											bar: {
												columnWidth: "55%", // Decrease this percentage to make bars thinner
											},
										},
									}}
									series={[
                    ...
                    <i className="ti ti-calendar me-1"></i>2025
							...
							<div className='card-body pb-0'>
								<div className='d-flex align-items-center justify-content-between flex-wrap mb-3'>
									<div className='mb-1'>
										<h5 className='mb-2 fs-14 fw-bold'>89,878.58</h5>
								...
								<Chart
									...
									series={[
										{
											name: "Resolved Complaints", // Submitted via website/app
											data: [4000, 5000, 6000, 7000],
										},
										{
											name: "Pending Complaints", // Registered in person
											data: [3000, 4000, 3500, 5000],
										},
										{
											name: "Cancelled Complaints", // Logged by support/field agents
                    ...
                    <i className="ti ti-calendar me-1"></i>Last 30 Days
							...
							<div className='card-body'>
								<div
									...
									<Chart
										options={{
											labels: ["New", "Discussion", "Resolved", "Cancelled"],
											colors: [
												"#3498db",
												"#f1c40f",
												"#9b59b6",
											...
											<div className='d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3'>
												<div className='d-flex align-items-center gap-2 flex-wrap'>
													...
													<div
														...
														<IconCalendarDue
															className='text-dark fs-14 me-1'
															size={18}
														/>
